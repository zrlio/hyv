...
#ifndef _VHOST_RDMACM_DEBUG_H
#define _VHOST_RDMACM_DEBUG_H
 ...
 * DBG_VHOST    vhost
 * DBG_CM       Connection management operations
 * DBG_EVT      CM events
 * DBG_ALL	    All categories above
 */
#define DBG_ON 0x00000001
#define DBG_VHOST 0x00000002
#define DBG_CM 0x00000004
#define DBG_EVT 0x00000008
#define DBG_ALL (DBG_ON | DBG_VHOST | DBG_CM | DBG_EVT)
