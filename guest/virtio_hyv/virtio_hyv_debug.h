...
#ifndef _VIRTIO_HYV_DEBUG_H
#define _VIRTIO_HYV_DEBUG_H
 ...
 * DBG_VIRTIO   Virtio
 * DBG_BUS      Bus events
 * DBG_CONF     Virtio configuration
 * DBG_IBV      Verbs
 * DBG_MEM      Memory management
 * DBG_EVT      Events
 * DBG_KVERBS   Kernel verbs
 * DBG_ALL	    All categories above
 */
#define DBG_ON 0x00000001
#define DBG_VIRTIO 0x00000002
#define DBG_BUS 0x00000004
#define DBG_CONF 0x00000008
#define DBG_IBV 0x00000010
#define DBG_MEM 0x00000020
#define DBG_EVT 0x00000040
#define DBG_KVERBS 0x00000080
#define DBG_ALL                                                                \
	(DBG_ON | DBG_VIRTIO | DBG_BUS | DBG_CONF | DBG_IBV | DBG_MEM |        \
	 DBG_EVT | DBG_KVERBS)
