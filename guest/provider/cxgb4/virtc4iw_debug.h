...
#ifndef _VIRTC4IW_DEBUG_H
#define _VIRTC4IW_DEBUG_H
 ...
 * DBG_DEV      Device events
 * DBG_IBV      Verbs
 * DBG_ATTR     Attributes
 * DBG_KVERBS   Kernel verbs operations
 * DBG_C4IW     Provider
 * DBG_ALL	All categories above
 */
#define DBG_ON 0x00000001
#define DBG_DEV 0x00000002
#define DBG_IBV 0x00000004
#define DBG_ATTR 0x00000008
#define DBG_KVERBS 0x00000010
#define DBG_C4IW 0x00000020
#define DBG_ALL (DBG_ON | DBG_DEV | DBG_IBV | DBG_ATTR | DBG_KVERBS | DBG_C4IW)
