...
#ifndef _VIRTIO_RDMACM_DEBUG_H
#define _VIRTIO_RDMACM_DEBUG_H
 ...
 * DBG_VIRTIO   Virtio
 * DBG_CM       Connection management
 * DBG_EVT      CM events
 * DBG_IBCLIENT Device (de-)registration
 * DBG_ALL	    All categories above
 */
#define DBG_ON 0x00000001
#define DBG_VIRTIO 0x00000002
#define DBG_CM 0x00000004
#define DBG_EVT 0x00000008
#define DBG_IBCLIENT 0x00000010
#define DBG_ALL (DBG_ON | DBG_VIRTIO | DBG_CM | DBG_EVT | DBG_IBCLIENT)
